        ...
        <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
            ...
            <div className="flex space-x-4 mb-6">
                <button
                    ...
                    className={`px-4 py-2 rounded-lg transition-colors ${activeTab === 'text'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg transition-colors ${activeTab === 'file'
                            ? 'bg-blue-600 text-white'
                            : 'bg-slate-700 text-slate-400 hover:bg-slate-600'
                        }`}
                >
            ...
            <div className="mb-6">
                {activeTab === 'text' ? (
                    <textarea
                        className="w-full h-32 bg-slate-900 border border-slate-700 rounded-lg p-4 text-slate-300 focus:outline-none focus:border-blue-500 transition-colors"
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className="p-6 bg-slate-900 border border-slate-700 border-dashed rounded-xl hover:border-blue-500 hover:bg-slate-800/50 transition-all group text-center"
                            >
                                <div className="w-12 h-12 bg-red-500/10 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                                ...
                                <p className="text-xs text-slate-500 mt-1">PDF, DOC, TXT</p>
                            </button>
